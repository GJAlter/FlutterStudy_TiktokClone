...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(appName) => "Log into your ${appName} account";
  ...
  static String m6(appName, when) => "Sign up for ${appName} ${when}";

  final messages = _notInlinedMessages(_notInlinedMessages);
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        "alreadyHaveAnCount":
            MessageLookupByLibrary.simpleMessage("Already have an count?"),
        "authApple":
